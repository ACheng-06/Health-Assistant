    ...
    <div class="content">
      <div class="text">
        ...
        <div class="hero-actions">
          <el-button size="large" @click="goToConsultation">开始倾述，获得陪伴</el-button>
          <el-button size="large" style="border-color: #fff" color="transparent"
            @click="goToEmotionDiary">记录心情，释放情感</el-button>
        </div>
      </div>
      <div class="robot">
        <el-image style="width: 150px; height: 150px" :src="iconUrl" />
      </div>
    </div>
  </div>
</template>
